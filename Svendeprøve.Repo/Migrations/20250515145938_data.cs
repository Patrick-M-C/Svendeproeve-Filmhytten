...
namespace Svendeprøve.Repo.Migrations
{
    ...
    public partial class data : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "Email", "IsAdmin", "Name", "Password", "PhoneNumber" },
                values: new object[,]
                {
                    { 1, "kasper@mail.com", false, "Kasper", "placeholder1", "123456789" },
                    { 2, "sofia@mail.com", true, "Sofia", "placeholder2", "987654321" }
                });
